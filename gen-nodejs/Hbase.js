...
Hbase_checkAndPut_args.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        this.attributes = {};
        var _rtmp3390 = input.readMapBegin();
        var _size389 = _rtmp3390.size || 0;
        for (var _i391 = 0; _i391 < _size389; ++_i391) {
          var key392 = null;
          var val393 = null;
          key392 = input.readBinary();
          val393 = input.readBinary();
          this.attributes[key392] = val393;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
Hbase_checkAndPut_args.prototype.write = function(output) {
  ...
  if (this.attributes !== null && this.attributes !== undefined) {
    ...
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRING, Thrift.objectLength(this.attributes));
    for (var kiter394 in this.attributes) {
      if (this.attributes.hasOwnProperty(kiter394)) {
        var viter395 = this.attributes[kiter394];
        output.writeBinary(kiter394);
        output.writeBinary(viter395);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
